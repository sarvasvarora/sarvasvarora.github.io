...
image:
  feature: website-images/header.jpg
  credit: My cat Родная (Radnaya) 😸
  creditlink: https://www.instagram.com/radnaya.purrs
---
## सर्वस्व अरोड़ा 

<figure>
    <img src="/images/author-images/sarvasv-as-a-kid.jpg" alt="test">
    <figcaption>Me @4 with my sister @2 (in background: Taj Mahal Palace Hotel, Mumbai)</figcaption>
</figure>
...
If you feel that this website seems (kinda) familiar, then you're not wrong! It's based on the famous [Minimal Mistakes](https://mmistakes.github.io/minimal-mistakes/) theme powered by [Jekyll](https://jekyllrb.com).  
\
Big shoutout to [Jordi Pont-Tuset](https://jponttuset.cat); much of the initial code for this website came from his repository, with some major tweaks done by me. 